...
export const quizQuestions: QuizQuestion[] = [
  ...
  {
    id: 18,
    question: 'Você está REALMENTE pronto(a) para ACABAR com as espinhas de vez?',
    emoji: '🚀',
    type: 'single',
    options: [
      ...
      { id: 'anything', label: 'FAREI QUALQUER COISA!', emoji: '🔥' },
    ],
  },
];
...
export const testimonials = [
  {
    ...
    text: 'Minha pele era cheia de espinhas, principalmente no queixo. Em 6 dias usando o Segredo Coreano, as inflamações sumiram. Hoje me sinto outra pessoa!',
    rating: 5,
  ...
  },
  {
    ...
    text: 'Gastei mais de R$2.000 em dermatologista e nada funcionava. Com esse método simples, em 5 dias minhas espinhas praticamente desapareceram. Inacreditável!',
    rating: 5,
  ...
  },
  {
    ...
    text: 'Tinha vergonha de sair de casa por causa das espinhas. Depois de descobrir o Segredo Coreano, minha autoestima voltou. Meus amigos nem acreditaram na mudança!',
    rating: 5,
  ...
  },
  {
    ...
    text: 'Minhas espinhas me faziam chorar todo dia. Depois de usar o Segredo Coreano certinho, em 10 dias já vi diferença. Hoje tiro fotos sem medo! Super recomendo.',
    rating: 5,
...
export const analysisSteps = [
  ...
  'Descobrindo o Segredo Coreano ideal para você...',
];
